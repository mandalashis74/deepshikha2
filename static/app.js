...
window.getDefaultRoles = function() {
    return [
        ...
        { name: 'editor', label: 'Editor', permissions: ['dashboard:view','income:create','income:approve','expense:create','history:view','reports:view','ledger:export','tickets:resolve','tickets:comment','board:view','board:create','board:moderate','meetings:view','resolutions:view'], color: 'var(--color-rose)' },
        { name: 'floor_manager', label: 'Floor Manager', permissions: ['dashboard:view','income:create','income:approve','history:view','reports:view','tickets:recommend','tickets:comment','board:view','board:create','meetings:view','resolutions:view'], color: 'var(--color-yellow)' },
        { name: 'committee_member', label: 'Committee Member', permissions: ['dashboard:view','income:approve','history:view','reports:view','tickets:approve','tickets:comment','board:view','board:create','board:moderate','committee:view','meetings:view','meetings:create','meetings:manage','resolutions:view','documents:view','documents:upload','compliance:view','compliance:create','compliance:manage','vendors:view','vendors:create','visitors:view','visitors:create','visitors:approve','assets:view','assets:create','assets:manage','polls:view','polls:create','polls:vote','parking:view','parking:assign','handover:view','handover:create','analytics:view','maintenance:view','maintenance:manage_rates','maintenance:collect','security:view','security:manage','gate:view','gate:guard'], color: 'var(--color-violet)' },
